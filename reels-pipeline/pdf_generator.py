...
# Diretórios
# TRANSCRIPTIONS_DIR é relativo à pasta atual (reels-pipeline-git/transcriptions)
TRANSCRIPTIONS_DIR = "transcriptions"
# PDF_OUTPUT_DIR aponta para a raiz do projeto (main/documents)
PDF_OUTPUT_DIR = Path(__file__).resolve().parent.parent / "documents"
...
def main():
    ...
    # PDF_OUTPUT_DIR já é um Path, mas garante que seja Path se necessário
    pdf_dir = PDF_OUTPUT_DIR if isinstance(PDF_OUTPUT_DIR, Path) else Path(PDF_OUTPUT_DIR)
